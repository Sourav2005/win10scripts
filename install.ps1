...
Expand-Archive -Path env:TEMP\winaerotweaker.zip -DestinationPath $env:TEMP\winaerotweaker\SilentSetup.cmd
Start-Process -FilePath $env:TEMP\winaerotweaker\Silent
